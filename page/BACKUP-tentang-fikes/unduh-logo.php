<?php
$dir = __DIR__ . "//fikes/admin/uploads/upload-logo/";
$url = "/fikes/admin/uploads/upload-logo/";
      ...
      <div class="container">
        <div class="download-box">
          <div class="download-box-content">
            ...
            <?php if ($logos): ?><a href="/fikes/tentang/download-logo" class="download-all">📦 Download Semua Logo</a>
