...
<body>
  ...
  <main>
    <section class="article-hero">
      <div class="container">
        <div class="breadcrumb"><a href="/fikes/">Beranda</a><span>›</span><a
            href="/fikes/#berita">Berita</a><span>›</span><span>Detail</span></div>
        <div class="hero-grid">
          <div>
              ...
              <article class="news-card"><a href="/fikes/berita/<?= rawurlencode($b['slug']) ?>"
                ...
                <div class="news-body"><span class="news-category"><?= e($b['kategori']) ?></span>
                  ...
                  <p><?= e($b['ringkasan']) ?></p><a class="read-more"
                    href="/fikes/berita/<?= rawurlencode($b['slug']) ?>">Baca Selengkapnya →</a>
                </div>
              </article>
            <?php endforeach; ?>
          </div>
  ...
  <footer>
    <div class="container footer-main">
      ...
      <div>
        ...
        <div class="footer-links">
          <a href="/fikes/program-studi">Profesi Ners</a>
          <a href="/fikes/program-studi">Ilmu Keperawatan</a>
          <a href="/fikes/program-studi">Farmasi</a>
          <a href="/fikes/program-studi">Kebidanan</a>
          <a href="/fikes/program-studi">K3</a>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="footer-links">
          ...
          <a href="/fikes//#pelayanan">Pelayanan FIKES</a>
