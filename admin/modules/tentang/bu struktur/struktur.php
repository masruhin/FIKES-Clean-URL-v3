...
<div class="modal <?= $edit ? 'show' : '' ?>" id="modalStruktur">
  <div class="modal-box large">
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="form-grid">
        <div><label>Periode</label><input type="text" name="periode" value="<?= e($edit['periode'] ?? '') ?>" required>
        </div>
        <div><label>SK Rektor</label><input type="text" name="sk_rektor" value="<?= e($edit['sk_rektor'] ?? '') ?>"
            required></div>
