 ...
 */
if (!function_exists('fikes_setting_value')) {
...
if (!function_exists('fikes_find_settings_table')) {
...
if (!function_exists('fikes_load_site_settings')) {
  function fikes_load_site_settings(PDO $pdo): array
  {
    ...
    $keyCol = null;
    $valueCol = null;
    foreach (['key', 'setting_key', 'nama', 'kunci', 'kode'] as $c) if (in_array($c, $columns, true)) {
      $keyCol = $c;
      break;
    }
    foreach (['value', 'setting_value', 'nilai', 'isi', 'konten'] as $c) if (in_array($c, $columns, true)) {
      $valueCol = $c;
      break;
    }
...
if (!function_exists('fikes_site_settings')) {
